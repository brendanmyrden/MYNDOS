          ...
          <div className="module-header-stack">
            <div className="module-header module-header-group">
              <div className="module-header-left">
                <ModuleCube moduleName="myndos" defaultEmoji="🧠" />
                <div>
                  <h1 className="module-title">MYND OS</h1>
                  <p className="module-subtitle">Your Data, Your World</p>
                </div>
              </div>
              <PlusCube moduleName="myndos" />
            </div>
            <div className="module-hover-panel">
              <ModuleHoverPanel moduleName="myndos" />
            </div>
          </div>
          <MatrixTimerWidget moduleName="myndos" />
          <MediaModalWidget moduleName="myndos" />
          <TableWidget moduleName="myndos" />
        </div>
      </div>
    </div>
  );
...
export default function MYNDOS() {
  return (
    <ModuleThemeProvider moduleName="myndos">
      <MYNDOSContent />
    </ModuleThemeProvider>
  );
}
